...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        int maxAttackLevel = tempPokemon.hitPoints - 1;
        System.out.println("Enter your attack level (1-" + maxAttackLevel + "):");
        tempPokemon.attackLevel = myScan.nextInt();
        while (tempPokemon.attackLevel < 1 || tempPokemon.attackLevel > maxAttackLevel) {
            System.out.println("Sorry. The attack level must be between 1 and " + maxAttackLevel + ":");
            tempPokemon.attackLevel = myScan.nextInt();
        }
        int maxDefenseLevel = tempPokemon.hitPoints - tempPokemon.attackLevel;
